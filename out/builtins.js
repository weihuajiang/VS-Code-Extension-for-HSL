...
exports.BUILTIN_FUNCTIONS = [
    ...
    },
    {
        ...
        documentation: "Returns the recordset object associated with the current data access context.\n\n**Return:** Recordset object (object).",
    ...
    },
    {
        ...
        documentation: "Returns the sequence object.\n\n**Return:** Sequence object (object).",
    ...
    },
    {
        ...
        documentation: "Returns the executor object associated with the current execution context.\n\n**Return:** Executor object (object == IHxExecute*).",
    ...
    },
    {
        ...
        documentation: "Returns the identifier of the current task.\n\n**Return:** Task identifier (integer); 0 if no current task.",
    ...
    },
    {
        ...
        documentation: "Returns the view name of the current task.\n\n**Return:** View name (string); empty if no current task.",
    ...
    },
    {
        ...
        documentation: "Returns the view name of the current activity of the current task. Call within activity blocks.\n\n**Return:** Activity view name (string); empty if no current activity.",
    ...
    },
    {
        ...
        documentation: "Returns the ideal duration in seconds of the current activity.\n\n**Return:** Duration in seconds (float); -1 if no current activity.",
    ...
    },
    {
        ...
        documentation: "Returns the planned duration in seconds of the current activity.\n\n**Return:** Duration in seconds (float); -1 if no current activity.",
    ...
    },
    {
        ...
        documentation: "Returns the path and name of the topmost HSL source file (the workflow file).\n\n**Return:** File path (string).",
    ...
    },
    {
        ...
        documentation: "Enables the reschedule-statement when triggered via IHxSchedule::Schedule().",
    ...
    },
    {
        ...
        documentation: "Disables the reschedule-statement when triggered via IHxSchedule::Schedule().",
    ...
    },
    {
        ...
        documentation: "Indicates whether the reschedule-statement is enabled when triggered via IHxSchedule::Schedule(). Defaults to hslTrue.\n\n**Return:** Non-zero if enabled; 0 if disabled.",
    ...
    },
    {
        ...
        documentation: "Sets all Scheduler control settings. Use `hslUseDefault` for any parameter to keep the current value.\n\n**Parameters (all [in]):** Same as GetSchedulerSettings.",
    ...
    },
    {
        ...
        documentation: "Returns the current run execution state.\n\n**Return:** 1 = scheduling, 2 = executing.",
...
exports.ELEMENT_FUNCTIONS = [
    ...
    },
    {
        ...
        documentation: "Removes all sequences from the collection holding the editable sequences of the device.",
    ...
    },
    {
        ...
        documentation: "Returns the command object associated with this device (object == IHxGruCommandRunX*, where X = highest interface index).",
    ...
    },
    {
        ...
        documentation: "Returns the elapsed time relative to the timer start event in seconds as a floating point number with millisecond resolution.",
    ...
    // ── Resource ─────────────────────────────────────────────────────
    {
        ...
        documentation: "Returns the maximum number of resource units (integer, constant during a run).",
    ...
    },
    {
        ...
        documentation: "Returns the number of currently enabled resource units (integer).",
    ...
    },
    {
        ...
        documentation: "Returns the number of currently available resource units (integer, numberOfAvailableUnits = numberOfActualUnits - numberOfDisabledUnits).\n\n**Remark:** This value is not available until the workflow is executed.",
    ...
    },
    {
        ...
        documentation: "Returns the (user defined) view name of the resource (string).",
    ...
    },
    {
        ...
        documentation: "Enables all units of the resource.\n\n**Return:** Non-zero if the function was successful; otherwise zero (0).",
    ...
    },
    {
        ...
        documentation: "Reads the next record from the file data source as string-valued data. Row data, but no schema data, is saved to the string. After calling ReadString, the next unread record becomes the current record.\n\n**Return:** The contents of the next field in the file data source as string-valued data (string). A run-time error in case of an error.",
...
exports.KEYWORDS = [
    ...
    },
    {
        ...
        documentation: "The `loop` statement creates an indefinite loop that repeats until explicitly exited with `break`.\n\n**Syntax:**\n```\nloop(repeat)\n{\n    // statements\n    break;\n}\n```\n\n`repeat` is a constant non-negative integer specifying the maximum number of iterations. Use 0 for infinite.",
    },
    {
        name: "next",
        description: "Skip to the next loop iteration",
        documentation: "The `next` statement skips the remainder of the current loop iteration and continues with the next iteration.\n\nSimilar to `continue` in C/C++.",
    },
    {
        name: "lock",
        description: "Lock access to a synchronized scope",
        documentation: "The `lock` statement locks access to a shared resource. Used with `synchronized` variables to prevent concurrent access in multi-threaded scenarios.\n\n**Usage:** `lock(syncVariable) { ... }`",
    },
    {
        name: "unlock",
        description: "Unlock access to a synchronized scope",
        documentation: "The `unlock` statement releases a previously acquired lock on a synchronized variable.\n\n**Usage:** Used in conjunction with `lock` for thread synchronization.",
    },
    {
        name: "pause",
        description: "Pause execution of the method",
        documentation: "The `pause` statement pauses execution of the method. Execution can be resumed by user interaction.",
    },
    {
        name: "goto",
        description: "Jump to a labeled statement",
        documentation: "The `goto` statement transfers execution to a labeled statement within the same scope.\n\n**Usage:** `goto <label>;`\n\nCommonly used with `onerror goto` for error handling.",
    },
];
/**
